...
export default function Footer() {
  ...
  return (
    ...
    <footer className="flex flex-col bg-blue-gray-400 w-full px-4 items-center justify-center gap-y-6 border-t border-blue-gray-400 py-6 text-center md:flex-row md:justify-between md:px-12">
      ...
      <ul className="flex flex-wrap items-center gap-y-2 gap-x-8 md:gap-x-12">
        <li>
          <Popover placement="bottom-end">
            <PopoverHandler>
              <Typography
                as="a"
                color="blue-gray"
                className="font-normal cursor-pointer transition-colors hover:text-blue-500 focus:text-blue-500"
              >
                {" "}
                Contact us
              </Typography>
            </PopoverHandler>
            <PopoverContent className="w-auto gap-4 z-20 flex flex-col sm:flex-row">
